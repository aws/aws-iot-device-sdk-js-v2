...
For those who prefer to dive right in, you can start with our [Greengrass IPC example](https://github.com/aws/aws-iot-device-sdk-js-v2/blob/main/samples/node/greengrass/gg_ipc).  
The associated [README](https://github.com/aws/aws-iot-device-sdk-js-v2/blob/main/samples/node/greengrass/gg_ipc/README.md) contains instructions for how to perform a local greengrass deployment of the sample
as a component.
