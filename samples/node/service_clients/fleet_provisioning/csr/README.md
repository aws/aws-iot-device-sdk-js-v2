...
<pre>
{
  ...
  "Statement": [
    ...
    },
    {
      "Effect": "Allow",
      "Action": "iot:Connect",
      "Resource": "arn:aws:iot:<b>region</b>:<b>account</b>:fleet-provisioning-csr-*"
    }
  ]
}
</pre>
...
npm install
node ./index.js --endpoint <endpoint> --cert <file> --key <file> --template_name <template name> --template_parameters <template parameters> --csr <path to csr file>
```
...
``` sh
# from the node/fleet_provisioning/csr folder
npm install
node ./dist/index.js --endpoint <endpoint> --cert <file> --key <file> --template_name <template name> --template_parameters '{"SerialNumber":"1","DeviceLocation":"Seattle"}' --csr <path to csr file>
```
