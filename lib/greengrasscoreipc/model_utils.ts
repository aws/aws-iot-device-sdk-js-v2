...
export function validateMQTTMessage(value : model.MQTTMessage) : void {
    ...
    eventstream_rpc_utils.validateValueAsOptionalEnum(value.payloadFormat, PayloadFormatValues, 'payloadFormat', 'MQTTMessage');
...
export function validateMetric(value : model.Metric) : void {
    ...
    eventstream_rpc_utils.validateValueAsEnum(value.unit, MetricUnitTypeValues, 'unit', 'Metric');
...
export function validateLocalDeployment(value : model.LocalDeployment) : void {
    ...
    eventstream_rpc_utils.validateValueAsEnum(value.status, DeploymentStatusValues, 'status', 'LocalDeployment');
}
...
export function validateConfigurationValidityReport(value : model.ConfigurationValidityReport) : void {
    eventstream_rpc_utils.validateValueAsEnum(value.status, ConfigurationValidityStatusValues, 'status', 'ConfigurationValidityReport');
...
export function validateComponentDetails(value : model.ComponentDetails) : void {
    ...
    eventstream_rpc_utils.validateValueAsEnum(value.state, LifecycleStateValues, 'state', 'ComponentDetails');
...
export function validateCertificateOptions(value : model.CertificateOptions) : void {
    eventstream_rpc_utils.validateValueAsEnum(value.certificateType, CertificateTypeValues, 'certificateType', 'CertificateOptions');
}
...
export function validateStopComponentResponse(value : model.StopComponentResponse) : void {
    eventstream_rpc_utils.validateValueAsEnum(value.stopStatus, RequestStatusValues, 'stopStatus', 'StopComponentResponse');
...
export function validateUpdateStateRequest(value : model.UpdateStateRequest) : void {
    eventstream_rpc_utils.validateValueAsEnum(value.state, ReportedLifecycleStateValues, 'state', 'UpdateStateRequest');
}
...
export function validateRestartComponentResponse(value : model.RestartComponentResponse) : void {
    eventstream_rpc_utils.validateValueAsEnum(value.restartStatus, RequestStatusValues, 'restartStatus', 'RestartComponentResponse');
...
export function validateSubscribeToTopicRequest(value : model.SubscribeToTopicRequest) : void {
    ...
    eventstream_rpc_utils.validateValueAsOptionalEnum(value.receiveMode, ReceiveModeValues, 'receiveMode', 'SubscribeToTopicRequest');
}
...
export function validatePublishToIoTCoreRequest(value : model.PublishToIoTCoreRequest) : void {
    ...
    eventstream_rpc_utils.validateValueAsEnum(value.qos, QOSValues, 'qos', 'PublishToIoTCoreRequest');
    ...
    eventstream_rpc_utils.validateValueAsOptionalEnum(value.payloadFormat, PayloadFormatValues, 'payloadFormat', 'PublishToIoTCoreRequest');
...
export function validateSubscribeToIoTCoreRequest(value : model.SubscribeToIoTCoreRequest) : void {
    ...
    eventstream_rpc_utils.validateValueAsEnum(value.qos, QOSValues, 'qos', 'SubscribeToIoTCoreRequest');
}
